...
![](/img/git_add_ssh_key.jpeg "gitee-add-ssh-key")

点击“确定”即可完成并看到刚才添加的Key：

![](/img/git_key.jpeg "gitee-key")

如果我们已经有了一个本地的git仓库（例如，一个名为learngit的本地库），如何把它关联到码云的远程库上呢？

首先，我们在码云上创建一个新的项目，选择右上角用户头像 -&gt; 菜单“控制面板”，然后点击“创建项目”：

![](/img/git_new_repo.jpeg "gitee-new-repo")
...
```bash
git remote -v
origin    git@github.com:michaelliao/learngit.itgit (fetch)
...
![](/img/git_multi_remote.jpeg "multi-remote")
